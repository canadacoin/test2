...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7147700cff04a3ca696879bba83a3930a17bb55267aab5921424a7a85e931955");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Nontraditionally one puts something timely here coinciding with the epoch";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393500278; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1393500278;
            block.nNonce   = 1886131;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4a00f361530020c4a3fab153e38cbd522807d534ca9650575b54c84ccaf6ebd7"));
